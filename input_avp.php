            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="form-operation" method="POST" action="inputavp_aksi.php">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-4 mb-3">
                                    <label for="grup" class="sub-judul mb-2">TOTAL HANDLING : </label>
                                    <input type="number" class="form-control" id="total_tonase" name="total_tonase"
                                        style="border: 1px solid #0a2443; color: #0a2443;"
                                        placeholder="Total Handling (gunakan titik untuk koma)" step="0.01">
                                </div>
                                <div class="col-lg-4 mb-3">
                                    <label for="pic" class="sub-judul mb-2">TOTAL KOMPLAIN :</label>
                                    <input type="number" class="form-control" id="point_complain" name="point_complain"
                                        style="border: 1px solid #0a2443; color: #0a2443;" placeholder="Total Komplain">
                                </div>
                                <div class=" col-lg-4 mb-3">
                                    <label for="pengawas" class="sub-judul mb-2"> KUMULATIF :</label>
                                    <input type="number" class="form-control" id="total_point" name="total_point"
                                        style="border: 1px solid #0a2443; color: #0a2443;"
                                        placeholder="Kumulatif (gunakan titik untuk koma)" step="0.01">
                                </div>
                            </div>
                            <div class="text-center mt-4">
                                ...
                                <button type="button" class="btn btn-custom-edit"
                                    onclick="window.location.href='data_peserta_avp.php'">Kembali</button>
                            </div>
                        </form>
                    </div>
                </div>
