    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <header class="app-header">
            <nav class="navbar navbar-expand-lg navbar-light">
                <ul class="navbar-item logo-left">
                    <li>
                        <a href="login.php">
                            <img src="./assets/images/logos/bumnlogo.png" class="logo">
                        </a>
                    </li>
                </ul>

                <ul class="navbar-item title-center">
                    <li>
                        <h3 class="tulisanlogo">BatuPACKWARrior</h3>
                    </li>
                </ul>

                <ul class="navbar-item logo-right">
                    <li>
                        <img src="./assets/images/logos/balogo.png" class="logo-report">
                    </li>
                </ul>
            </nav>
